...
class bracket_game:
    ...
    def predict(self, teams):
        ...
        print(self.t1, team1ScorePrediction[0], self.t2, team2ScorePrediction[0])# Probably want to display games differently later! Could initialize brackets with coordinate locations for plotting.
        draw_game(self.x, self.y, self.t1, team1ScorePrediction[0], self.t2, team2ScorePrediction[0])
